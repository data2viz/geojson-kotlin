...
val gitHubRepoUrl = "https://github.com/data2viz/geojson-kotlin"

val buildAndPublishExpectedToTake = "less than 10 minutes"
val suggestionsIfBuildTakesLonger = listOf(
    "We recommend to set a timer for 10 minutes to not forget to check the status.",
    "Suggestion: In case it's not complete after that time, set a 5min timer to check again, until completion."
)
